...
#weights = json.load(open('filename')) # to load saved weights

# Train and test nn
epochs = 2 # number of times it trains on the whole training set
...
#    print('Weights saved') #weights = json.load(open('out.weights_lunch1')) # to load saved weights
...
print('Total runtime', time.time()-t0, 'sec')
print('Done')
